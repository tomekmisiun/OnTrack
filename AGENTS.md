...
same-provider review via `scripts/ai/invoke-cross-reviewer.sh codex` if Claude
is unavailable. No second user prompt, pasted handoff, local runner command, or
