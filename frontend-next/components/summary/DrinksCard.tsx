/* eslint-disable @typescript-eslint/ban-ts-comment, @typescript-eslint/no-unused-vars, @typescript-eslint/no-unused-expressions, react-hooks/exhaustive-deps */
// @ts-nocheck — ported from CRA DrinksCard.js; tighten types incrementally.
"use client";
...
function DrinksCard({ days, periodLabel, productList, onUpdate, pieCategories = [] }: DrinksCardProps) {
  ...
  const [drinks, setDrinks] = useState(loadDrinksFromStorage);
