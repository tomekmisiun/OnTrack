...
Ingredient aliases (canonical name mappings) are defined in:
    scraper/data/ingredient_aliases.json  ← edit this file to fix bad matches
"""
...
# Ingredient aliases — translate recipe names to canonical shop names before matching.
# Loaded from JSON so they can be edited without touching this file.
_aliases = json.loads((DATA / "ingredient_aliases.json").read_text("utf-8"))
