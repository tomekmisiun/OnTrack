...
from data_paths import (  # noqa: E402
    ...
    INGREDIENT_DB_PL,
    INGREDIENTS_MACROS,
    INGREDIENTS_MACROS_PARTIAL,
)

INPUT_FILE_EN = INGREDIENT_DB_EN
INPUT_FILE_PL = INGREDIENT_DB_PL
OUTPUT_FILE   = INGREDIENTS_MACROS
PARTIAL       = INGREDIENTS_MACROS_PARTIAL
