...
Run as part of the pipeline or standalone: python pipeline/dump_seeds.py
...
def _unavailable_ingredients(lang: str) -> set[str]:
    if not INGREDIENT_ALIASES.exists():
        return set()
    aliases = json.loads(INGREDIENT_ALIASES.read_text("utf-8")).get(lang, {})
