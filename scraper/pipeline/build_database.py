...
def main():
    ...
    matches_en = json.loads(MATCHES_EN.read_text("utf-8"))
    matches_pl = json.loads(MATCHES_PL.read_text("utf-8"))
    recipes    = json.loads(RECIPES_NORMALIZED.read_text("utf-8"))
    ...
    aliases = json.loads(INGREDIENT_ALIASES.read_text("utf-8"))
    unavailable_pl = {
        name.lower()
    ...
    save(INGREDIENT_DB_EN, list(db_en.values()))
    save(INGREDIENT_DB_PL, list(db_pl.values()))
    save(RECIPES_EN,   recipes_en)
    save(RECIPES_PL,   recipes_pl)
