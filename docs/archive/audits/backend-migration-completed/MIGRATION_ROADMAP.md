> **HISTORICAL DOCUMENT** — Archived MIGRATION_ROADMAP.md. For current state see [`docs/CURRENT_STATE.md`](../../CURRENT_STATE.md).
...
**Status:** ✅ Complete — R01–R09 routes and contract tests.
